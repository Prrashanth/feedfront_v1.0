...
//                                }
         //                   }
                            ...
                            {
                                if (typeof(result[i][Object.keys(result[i])[j]])=='string' && result[i][Object.keys(result[i])[j]].match(/[^0-9a-zA-Z ]/g)) {
                                    result[i][Object.keys(result[i])[j]] = result[i][Object.keys(result[i])[j]].replace(/[^0-9a-zA-Z ]/g, '');
                                }
                                if(typeof(result[i][Object.keys(result[i])[j]])=='number')
                                {
                                    err = false;
                                }
//                                console.log(result[i][Object.keys(result[i])[j]]);
